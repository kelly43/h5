...
HotyiCommon.prototype={
    ...
    showRankingList:function(call){
        ...
        var wrap = KWhaleUtils.addDomByScale(s,549/1135,578/1135,338/1135,"");
    ...
    showDefeatPanel:function(scores){
        ...
        if(that._gc._isTest){
            ...
            that._iHotyi.iUserWinNum(function (data) {
                ...
                if (returnData.Code == 1 && returnData.Data.Statue) {
                    showPanel();
                } else {
                    window.location.href = that._config._errRedirect_1;
                }
